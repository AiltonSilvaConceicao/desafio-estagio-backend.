                ...
                <div class="card card-custom">
                    <div class="card-header card-header-tabs-line">
                        <div class="card-title">
                            <h3 class="card-label">Dashboard - Pesquisa Por Ordenação (asc e desc)</h3>
                        </div>
                                            ...
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <div class="input-group">
                                                        <select class="custom-select form-control" name="ordene" id="ordene">
                                                        <option value="">Selecione</option>
                                                        @php 
                                                        $ordene = array('asc', 'desc');
                                                        $descriptions = array('Ascendente', 'Descendente');
                                                        @endphp
                                                        @for ($i=0; $i < count($ordene); $i++)
                                                            <option value="{{$ordene[$i]}}">{{$descriptions[$i]}}</option>
                                                        @endfor
												        </select>

                                                        <input type="hidden" name="route_search" id="route_search" value="{{ route('search-filter-ordem') }}">
...
{{-- Scripts Section --}}
@section('scripts')
    <script src="{{ asset('../resources/metronic/js/pages/search_ordem.js') }}" type="text/javascript"></script>
@endsection
